...
export { default as DefectManagement } from './components/DefectManagement';
export { default as QualityTemplates } from './components/QualityTemplates';
export { default as QualityStandards } from './components/QualityStandards';
export { default as QualityAlerts } from './components/QualityAlerts';
