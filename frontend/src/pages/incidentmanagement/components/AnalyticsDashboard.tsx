...
const AnalyticsDashboard: React.FC<AnalyticsDashboardProps> = ({ projectId }) => {
  ...
  const loadAnalytics = async () => {
    setLoading(true);
    try {
      // Mock data for now - backend not implemented
      const mockAnalytics: IncidentAnalytics = {
        ...
        capa_completion_rate: 0.92,
        average_time_to_close: 12.5,
        average_cost_per_incident: 1570,
        ...
        risk_distribution: [
          { risk_level: 'Very High', count: 12 },
          { risk_level: 'High', count: 35 },
          { risk_level: 'Medium', count: 67 },
          { risk_level: 'Low', count: 42 }
        ],
        top_incident_types: [
        ...
        monthly_trends: [
          { month: 'Jan', incidents: 18, cost: 28500 },
          { month: 'Feb', incidents: 15, cost: 23400 },
          { month: 'Mar', incidents: 22, cost: 34200 },
          { month: 'Apr', incidents: 19, cost: 29800 },
          { month: 'May', incidents: 25, cost: 39100 },
          { month: 'Jun', incidents: 21, cost: 32800 }
        ]
      };
