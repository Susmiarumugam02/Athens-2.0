...
import { Card, Select, Checkbox, Input, Divider, Space, Tag, Row, Col, Form } from 'antd';
...
const RiskAssessmentSection: React.FC<Props> = ({ permitType, onChange }) => {
  ...
  return (
    ...
    >
      ...
      {/* ── HAZARD CHECKBOXES ── */}
      <Divider orientation="left" style={{ marginTop: 20, fontWeight: 600 }}>
      ...
      <div style={{ marginTop: 12 }}>
        <label style={{ fontWeight: 600, display: 'block', marginBottom: 6 }}>Other Hazards</label>
        <TextArea
          rows={2}
          value={otherHazards}
      ...
      {/* ── RISK CONTROLS ── */}
      <Divider orientation="left" style={{ marginTop: 20, fontWeight: 600 }}>Risk Controls</Divider>
      ...
      <Form.Item
        label={<span style={{ fontWeight: 600 }}>Control Measures</span>}
