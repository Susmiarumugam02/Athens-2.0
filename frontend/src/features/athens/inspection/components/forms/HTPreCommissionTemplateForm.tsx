...
const HTPreCommissionTemplateForm: React.FC = () => {
  ...
  const handleCancel = () => {
    navigate('/dashboard/inspection/forms/ht-precommission-template/list');
  };
  ...
  const handleSubmit = async () => {
    try {
      ...
      message.success("HT Pre-Commission Template form submitted successfully!");
      navigate('/dashboard/inspection/forms/ht-precommission-template/list');
    } catch (error) {
  ...
  return (
    <PageLayout
      ...
      breadcrumbs={[
        ...
        { title: 'HT Pre-Commission Template', href: '/dashboard/inspection/forms/ht-precommission-template/list' },
        { title: 'Create' }
      ]}
      actions={[
...
export default HTPreCommissionTemplateForm;