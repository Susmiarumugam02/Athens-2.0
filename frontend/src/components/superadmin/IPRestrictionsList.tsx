  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <p className="text-gray-400">Manage IP-based access restrictions</p>
        <button
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-white/10">
                <th className="text-left py-3 px-4 text-sm font-medium text-gray-400">IP Address/Range</th>
            ...
            <tbody>
              {restrictions.map((restriction) => (
                <tr key={restriction.id} className="border-b border-white/5 hover:bg-white/5">
                  ...
                  <td className="py-3 px-4 text-gray-300">{restriction.description}</td>
                  <td className="py-3 px-4">
                    <span className={`px-2 py-1 rounded text-xs font-medium ${
