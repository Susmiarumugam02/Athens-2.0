...
class EmployeeSerializer(serializers.ModelSerializer):
    ...
    def validate_contact_number(self, value):
        """
        Ensure contact_number contains only digits and is a valid 10-digit number.
        """
        import re
        if value is None or str(value).strip() == '':
            # Allow empty? For employee contact we require value in this app. If optional, change behavior.
