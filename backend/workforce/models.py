...
class Employee(models.Model):
    ...
    # Role-based isolation fields
    created_by_admin = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='created_employees')
    created_by_admin_type = models.CharField(max_length=20, blank=True, help_text='client/epc/contractor')
    organization_type = models.CharField(max_length=20, blank=True, help_text='client/epc/contractor - for filtering')
