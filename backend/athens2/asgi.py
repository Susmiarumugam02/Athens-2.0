...
from chatbox.routing import websocket_urlpatterns as chat_ws  # noqa: E402
from ai.routing import websocket_urlpatterns as ai_ws          # noqa: E402
from chatbox.middleware import JwtAuthMiddleware               # noqa: E402

all_websocket_urlpatterns = chat_ws + ai_ws
